...
let state = {
  ...
  eventsPrivate: [
    { name: "Gold Backed – Board", date: "2018-10-09", reg: "Open" },
    { name: "Safe Wealth Dinner", date: "2018-03-12", reg: "Waitlist" },
  ],

  eventsPublic: [
    { name: "TBC Gala Night", date: "2018-05-14", reg: "Open" },
    { name: "Golden Public Networking", date: "2018-04-21", reg: "Closed" },
  ],

posts: [
  {
    id: 1,
    title: "New Reporting System",
    body: "The reporting system has been activated. Please review performance and sales reports on a monthly basis.",
    date: "2018-11-06",
    isNew: true,
    acknowledged: false,
    comments: [
      { by: "Company", text: "Received, thank you." }
    ]
  },
  {
    id: 2,
    title: "February Events Announcement",
    body: "Registration for February events is now open. Please confirm attendance before the end of the month.",
    date: "2018-8-19",
    isNew: false,
    acknowledged: true,
    comments: [
      { by: "Company", text: "Reviewed. We will confirm within two days." }
    ]
  },
  {
    id: 3,
    title: "Privacy Policy Update",
    body: "Privacy policies and permissions have been updated. Please review Privacy & Security.",
    date: "2018-11-03",
    isNew: false,
    acknowledged: false,
    comments: []
...
menu.querySelectorAll(".menu-item").forEach(btn => {
  ...
  openModal(
    ...
    [
      ...
      openModal(
        "تسجيل الخروج",
        `<div style="font-size:15px">   Do You Want To Log Out?</div>`,
        [
          {
            label: "إلغاء",
            className: "ghost",
  ...
  state.campaigns.forEach((c) => {
    ...
    li.innerHTML = `
      <div>
        ...
        <div class="muted tiny"> Statu</div>
      </div>
...
function renderSelectedPost(){
  ...
  if(!post){
    box.innerHTML = `<div class="muted">Select a post from the left to view details and add a comment.</div>`;

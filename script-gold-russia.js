...
let state = {
  ...
  eventsPrivate: [
    { name: "Gold Backed – Board", date: "2020-11-23", reg: "Open" },
    { name: "Safe Wealth Dinner", date: "2020-01-27", reg: "Waitlist" },
  ],

  eventsPublic: [
    { name: "TBC Gala Night", date: "2020-05-28", reg: "Open" },
    { name: "Golden Public Networking", date: "2020-09-11", reg: "Closed" },
  ],
...
posts: [
  {
    ...
    body: "Система отчетности была активирована. Пожалуйста, ежемесячно проверяйте отчеты по эффективности и продажам.",
    date: "2020-01-13",
    isNew: true,
    acknowledged: false,
    comments: [
  ...
  {
    id: 2,
    title: "Уведомление о мероприятиях в феврале",
    body: "Открыта регистрация на февральские мероприятия. Пожалуйста, подтвердите участие до конца месяца.",
    date: "2020-06-12",
    isNew: false,
    acknowledged: true,
    comments: [
      { by: "Company", text: "Проверено. Мы подтвердим в течение двух дней." }
    ]
  },
  {
    id: 3,
    title: "Обновление политики конфиденциальности",
    body: "Политика конфиденциальности и права доступа были обновлены. Пожалуйста, ознакомьтесь с разделом Privacy & Security.",
    date: "2020-05-03",
    isNew: false,
    acknowledged: false,
    comments: []
  ...
  openModal(
    ...
    ></iframe>
      ...
      openModal(
       ...
       `
       <iframe 
      src="privacy-policy-russia.html"
      style="width:100%;height:70vh;border:0;"
      loading="lazy"
    ></iframe>
        `,
...
function renderSelectedPost(){
  ...
  if(!post){
box.innerHTML = `<div class="muted">Выберите запись слева для просмотра и комментариев.</div>`;
